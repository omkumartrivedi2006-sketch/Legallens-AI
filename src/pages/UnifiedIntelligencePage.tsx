...
export const UnifiedIntelligencePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      {/* Top Banner / Header */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white/70 dark:bg-white/[0.045] backdrop-blur-md p-6 rounded-2xl border border-slate-200/80 dark:border-white/10 shadow-sm">
        <div className="space-y-1">
          <div className="flex items-center gap-2.5">
            ...
            <span className="hidden sm:inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20">
              Multi-Document
            </span>
          </div>
        ...
        {/* Workspace Mode Tabs */}
        <div className="flex items-center gap-1 bg-slate-200/50 dark:bg-white/[0.04] border border-slate-200/60 dark:border-white/10 p-1 rounded-xl backdrop-blur-xs self-start md:self-auto text-xs font-semibold">
          <button
            type="button"
      ...
      {documents.length === 0 && !isLoadingDocuments ? (
        <div className="py-20 text-center bg-white/70 dark:bg-white/[0.045] backdrop-blur-md rounded-2xl border border-slate-200/80 dark:border-white/10 p-8 space-y-4 max-w-lg mx-auto shadow-sm">
          <div className="h-14 w-14 rounded-2xl bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center mx-auto border border-blue-500/20">
          ...
          <Link
            to="/documents"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs shadow-sm transition-colors"
          >
