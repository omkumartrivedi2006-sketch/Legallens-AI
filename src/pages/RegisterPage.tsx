      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Start clarifying legal contracts and policies with AI-driven insights.
          </p>
        </div>
        ...
        {!isConfigured && (
          <div className="flex items-start gap-2.5 p-3.5 rounded-xl border border-amber-200/80 dark:border-amber-900/60 bg-amber-50/70 dark:bg-amber-950/20 text-xs text-amber-900 dark:text-amber-200">
            ...
            <div>
              <span className="font-semibold">Setup Notice:</span> Firebase environment keys have not yet been provided in <code className="px-1 py-0.5 rounded bg-amber-100 dark:bg-amber-900/50 font-mono">.env.local</code>. Real registration requires Firebase credentials.
            </div>
          </div>
        )}
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-normal">
                By creating an account, you acknowledge that LegalLens AI provides automated document analysis for educational and navigational purposes and does not formulate legal representation.
              </p>
